...
51. After a final review with my mentor, with his help, I added an extra feature to my game  which set the amount of game sets to 10 and added the score. The number of points (stars) User will have after playing 10 times with Alien, will be multiplied by 100 and displayed in the scores area.
52. I run all the tests again to make sure the code and its syntax are correct.
